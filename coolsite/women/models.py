...
class Women(models.Model):
    ...
    cat = models.ForeignKey('Category', on_delete=models.PROTECT, verbose_name='Категория', related_name='posts')
    slug = models.SlugField(max_length=255, unique=True, db_index=True, verbose_name='URL')
    tags = models.ManyToManyField('TagPost', blank=True, verbose_name='Теги', related_name='tags')
